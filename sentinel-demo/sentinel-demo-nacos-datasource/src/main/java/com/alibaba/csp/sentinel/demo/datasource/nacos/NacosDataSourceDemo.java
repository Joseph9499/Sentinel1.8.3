...
public class NacosDataSourceDemo {
    ...
    // nacos server ip
    private static final String remoteAddress = "139.196.13.246:8848";
    // nacos group
//    private static final String groupId = "Sentinel_Demo";
    private static final String groupId = "SENTINEL_GROUP";
    // nacos dataId
    private static final String dataId = "service-nav-flow-rules";
...
//    private static final String NACOS_NAMESPACE_ID = "${namespace}";
    private static final String NACOS_NAMESPACE_ID = "0716180a-2688-4b90-b093-824448164ac4";
